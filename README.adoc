...
:license: Palimpsest v0.8 (PMPL-1.0 OR PMPL-1.0)
...
This project is licensed under the **Palimpsest License v0.8** (dual PMPL-1.0 OR PMPL-1.0 with community ownership principles).

* **Code**: PMPL-1.0 OR PMPL-1.0 (your choice)
* **Documentation**: PMPL-1.0-4.0
