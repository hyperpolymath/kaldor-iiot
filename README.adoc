...
:experimental:
:url-github: https://github.com/hyperpolymath/Kaldor-IIoT
:url-gitlab: https://gitlab.com/hyperpolymath/Kaldor-IIoT
:url-bitbucket: https://bitbucket.org/hyperpolymath/Kaldor-IIoT
:url-codeberg: https://codeberg.org/hyperpolymath/Kaldor-IIoT

Industrial IoT Kaldor economics optimization
...
Kaldor-IIoT is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
