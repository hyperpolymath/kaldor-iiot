...
// Replace kaldor-iiot, Kaldor Iiot — See README.adoc for details., just run, Kaldor Iiot started successfully. with actuals
= kaldor-iiot — Quick Start for Users
:toc:
:toclevels: 2

== What is kaldor-iiot?

Kaldor Iiot — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./kaldor-iiot-portable
----
...
[source]
----
Kaldor Iiot started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/kaldor-iiot/wiki
